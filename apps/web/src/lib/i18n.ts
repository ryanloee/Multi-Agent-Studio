...
export const translations: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    "settings.reasoningPassthrough": "回传思考内容",
    "settings.reasoningPassthroughOn": "已启用：将 reasoning_content 回传给 API（MiMo/GLM 等模型需要）",
    "settings.reasoningPassthroughOff": "已关闭：不回传 reasoning_content",
  ...
  en: {
    ...
    "settings.reasoningPassthrough": "Reasoning Passthrough",
    "settings.reasoningPassthroughOn": "Enabled: pass reasoning_content back to API (required for MiMo/GLM)",
    "settings.reasoningPassthroughOff": "Disabled: do not pass reasoning_content back",
